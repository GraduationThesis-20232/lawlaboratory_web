...
<template>
    <div>
        <div class="min-h-screen bg-gradient-to-r from-teal-50 to-blue-50">
            <nav class="bg-white border-b border-gray-100 bg-gradient-to-r from-teal-100 to-blue-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard')">
                                    <div class="flex items-center">
                                        ...
                                        <a href="/" class="text-2xl font-bold text-gray-800 no-underline ml-2">
                                            LawLaboratory
                                        </a>
                                    </div>
                                </Link>
                            ...
                            <!-- Navigation Links -->
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex from-teal-50 to-blue-50">
                                ...
                                <a class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out"
                                   :href="'http://localhost:3000/chatbot/' + usePage().props.auth.authorization_token" target="_blank">
                                    Chatbot
                                </a>
                            </div>
                        </div>
            ...
            <!-- Page Heading -->
            <header class="bg-white shadow bg-gradient-to-r from-teal-50 to-blue-50" v-if="$slots.header">
